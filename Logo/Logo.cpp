	...
	: m_count(0)
{
	...
	*/
	const GLfloat x1 = 1.f;
	const GLfloat y1 = -1.f;
	const GLfloat x2 = 1.f;
	const GLfloat y2 = 1.f;
	const GLfloat x3 = -1.f;
	const GLfloat y3 = 1.f;
	const GLfloat x4 = -1.f;
	const GLfloat y4 = -1.f;
